  ...
  return (
    <div className="flex items-center justify-between p-5 bg-white border border-zinc-200 rounded-2xl shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-zinc-900">Masir Jafri</p>
          <p className="text-xs text-zinc-500">
            Software Engineer & Pipeline Creator
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <a
          ...
          className="p-2 border border-zinc-200 hover:border-zinc-400 bg-white hover:bg-zinc-50 text-zinc-600 hover:text-black rounded-xl shadow-sm transition-all"
